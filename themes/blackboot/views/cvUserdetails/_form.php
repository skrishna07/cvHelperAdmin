...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->emailField($model,'email',array('size'=>60,'maxlength'=>64)); ?>
	...
	<?php echo $form->checkBox($model,'newsletter', array('value'=>'Y', 'uncheckValue'=>'N')); ?>
		<?php echo $form->error($model,'newsletter'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'updates'); ?>
		<?php echo $form->checkBox($model,'updates', array('value'=>'Y', 'uncheckValue'=>'N')); ?>
